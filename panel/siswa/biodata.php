		...
		<div class="card">
			...
			<form method="post" action="">
				<div class="card-body">
					<?php
					$id = $_SESSION['id'];
					$sql = mysqli_query($koneksi, "SELECT * FROM calon_siswa_biodata WHERE siswa_id='$id'");
					...
					if(isset($_POST['nama_siswa'])){
						...
						$update = mysqli_query($koneksi, "UPDATE calon_siswa SET siswa_nama='$nama_siswa', siswa_tempat_lahir='$tempat_lahir', siswa_tanggal_lahir='$tanggal_lahir', siswa_no_hp='$nomor_hp' WHERE siswa_id='$id'") or die(mysqli_error($koneksi));
						
						if($update){
							$update2 = mysqli_query($koneksi, "UPDATE calon_siswa_biodata SET 
															biodata_nik='$nik', biodata_nisn='$nisn', biodata_hobi='$hobi', 
															biodata_asal_sekolah='$asal_sekolah', biodata_alamat_asal_sekolah='$alamat_sekolah', 
															biodata_agama='$siswa_agama', biodata_kewarganegaraan='$kewarganegaraan', 
							...
							if($update2){
								$update3 = mysqli_query($koneksi, "UPDATE calon_siswa_status SET status_biodata='1' WHERE siswa_id='$id'") or die(mysqli_error($koneksi));
								if($update3){
									echo '<script>document.location="index.php?p=biodata&sukses=1";</script>';
								}else{
									echo '<script>document.location="index.php?p=biodata&sukses=0&3";</script>';
								}
							}else{
								echo '<script>document.location="index.php?p=biodata&sukses=0&2";</script>';
							}
						}else{
							echo '<script>document.location="index.php?p=biodata&sukses=0&1";</script>';
						}
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" name="nama_siswa" class="form-control" onkeyup="this.value = this.value.toUpperCase()" value="<?=$row['siswa_nama']?>" autocomplete="off" required>
									<small class="form-text text-muted"><i>
								...
								<div class="col-sm-8">
									<div class="form-group">
										<div class="custom-control custom-radio">
											<input type="radio" name="jenis_kelamin" id="jenis_kelamin1" value="Laki-Laki" class="custom-control-input" <?php if($row['siswa_jenis_kelamin'] == 'Laki-Laki'){ echo 'checked'; } ?> required>
											<label style="cursor:pointer" class="custom-control-label" for="jenis_kelamin1">Laki-Laki</label>
										</div>
										<div class="custom-control custom-radio">
											<input type="radio" name="jenis_kelamin" id="jenis_kelamin2"  value="Perempuan" class="custom-control-input" <?php if($row['siswa_jenis_kelamin'] == 'Perempuan'){ echo 'checked'; } ?> required>
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" name="tempat_lahir" class="form-control" value="<?=$row['siswa_tempat_lahir']?>" autocomplete="off" required>
								</div>
							</div>
							
							<div class="form-group row">
								<?php
								$row_tgl = explode('-', $row['siswa_tanggal_lahir']);
								?>
						...
						<div class="col-md-6">
									...
									<div class="form-group form-group-default">
										...
										<select name="kabupaten" id="kabupaten" class="form-control">
											...
											if($biodata['biodata_kecamatan'] == ''){
												echo '<option value="">Pilih provinsi dahulu</option>';
											}else{
									...
									<div class="form-group form-group-default">
										...
										<select name="desa" id="desa" class="form-control">
											...
											if($biodata['biodata_desa'] == ''){
												echo '<option value="">Pilih Desa dahulu</option>';
											}else{
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									...
									<small class="text-muted">Contoh: Jl. Sunan Giri RT. 04 RW. 01, Sebelah Masjid Jami'</small>
								</div>
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="number" name="nomor_hp" class="form-control" value="<?=$row['siswa_no_hp']?>" autocomplete="off" required>
								</div>
							</div>
