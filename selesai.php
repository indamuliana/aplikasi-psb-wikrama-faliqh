    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
          <div>
            <h1>Hore..!!</h1>
            <h2>Pendaftaran Online Berhasil.</h2>
			
			<?php
			if(isset($_SESSION['level'])){
				$id = $_SESSION['id'];
				$sql = mysqli_query($koneksi, "SELECT * FROM calon_siswa WHERE siswa_id='$id' LIMIT 1");
			...
			<p>
			Hai <?=$row['nama_siswa']?><br>
			Kamu sudah berhasil Daftar sebagai calon siswa di SMK Wikrama 1 Garut.
			</p>
			<p>Selanjutnya silahkan masuk e halaman control panel untuk melengkapi data-data yang diperlukan.<p>
			<p>Berikut ini adalah Username dan Password kamu untuk Login.</p>
			<table class="table">
				<tr>
			...
			<p>Silahkan simpan dengan baik data Username dan Password kamu.</p>
			<p>Silahkan klik tombol di bawah ini untuk login</p>
			<a href="login.php?daftar=<?=$row['siswa_username']?>"><button class="download-btn"><i class="icofont-login"></i> LOGIN</button></a>
          </div>
        </div>
        <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img" data-aos="fade-up">
          <img src="assets/img/jurusan.png" class="img-fluid rounded" alt="">
        </div>
      </div>
    </div>
